...
int main() {
    ...
    sdds::searchNlist<Car, const char*> A;
    A.listArrayElements("All the cars: ", C, 7);
    ...
    sdds::searchNlist<Student, double> B;
    B.listArrayElements("All Students: ", S, 6);
    ...
    sdds::searchNlist<Employee, int> D;
    D.listArrayElements("All Employees: ", E, 6);
    ...
    sdds::searchNlist<int,int> F;
    //Creating an instance 'F' of class searchNlist to use its member function listArrayElements:
    F.listArrayElements("INTEGERS",a,6); 
